...
void setup() {
  ...
  PImage friends = loadImage("parker.jpg");  // 2. Change this to match the name of your photo. 
  size(548, 672);
  // 3. Set your friends as the background. 
background(friends);
  // 4. Find an image of a mustache, and drop it onto this sketch. 
  mustache = loadImage("cool.png"); // 5. Change this to match your file name.
...
if (mousePressed )
{
  ...
  mustache.resize(110,110);
image(mustache,mouseX-39,mouseY-60);
}
